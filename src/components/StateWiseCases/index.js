...
class StateCases extends Component {
  ...
  getCatgry = val => {
    this.setState({category: val, tabAct: false})
  }
      ...
      <div className="state-details">
        ...
        <div className="align-center-row">
          <div className="country-stats">
            <StateTotalData
              onGetCategory={this.getCatgry}
              eachStateTotalData={stateTotalData}
              active={tabAct}
            />
          </div>
        </div>
